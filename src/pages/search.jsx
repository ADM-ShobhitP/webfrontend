...
const config = {
      ...
      types: {
        results: {
          fields: [
            ...
            // "approvers.username.suggest",
            // "collectors.username.suggest",
            // "plant.name.suggest"
          ]
        }
      },
  ...
  results: {
    ...
    search_fields: {
      ...
      // "approvers.username.suggest": { weight: 2 },
      // "collectors.username.suggest": { weight: 2 },
      // "plant.name.suggest": { weight: 2 }
    },
    result_fields: {
      "details.name_client": { snippet: { size: 100, fallback: true } },
      // "approvers.username": { snippet: { size: 100, fallback: true } },
      // "collectors.username": { snippet: { size: 100, fallback: true } },
      // "plant.name": { snippet: { size: 100, fallback: true } },
    }
  },
